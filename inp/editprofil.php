<fieldset>
	...
	$sql =mysql_query("select * from tb_login where id_user='$sesi'") or die(mysql_error());
	...
	if (@$_POST['edit']) {
		...
		mysql_query("update tb_login set username = '$username', password = '$password', nama = '$nama', alamat = '$alamat' where id_user= '$sesi'") or die (mysql_error());
